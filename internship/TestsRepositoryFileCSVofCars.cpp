...
TestsRepositoryFileCSVofCars::TestsRepositoryFileCSVofCars()
{
...
void TestsRepositoryFileCSVofCars::testAll()
{
...
void TestsRepositoryFileCSVofCars::testLoadFromFile()
{
    RepositoryFileCSV<Car> repo = RepositoryFileCSV<Car>(this->fileName);
    repo.loadFromFile();
...
void TestsRepositoryFileCSVofCars::testSaveToFile()
{
    RepositoryFileCSV<Car> repo = RepositoryFileCSV<Car>(this->fileName);
...
void TestsRepositoryFileCSVofCars::testAddCar()
{
    RepositoryFileCSV<Car> repo = RepositoryFileCSV<Car>(this->fileName);
    repo.loadFromFile();
    repo.setFileName(this->fileNameOut);
...
void TestsRepositoryFileCSVofCars::testUpdateCar()
{
    RepositoryFileCSV<Car> repo = RepositoryFileCSV<Car>(this->fileName);
    repo.loadFromFile();
    repo.setFileName(this->fileNameOut);
...
void TestsRepositoryFileCSVofCars::testDeleteCar()
{
    RepositoryFileCSV<Car> repo = RepositoryFileCSV<Car>(this->fileName);
    repo.loadFromFile();
    repo.setFileName(this->fileNameOut);
...
void TestsRepositoryFileCSVofCars::testfindCar()
{
    RepositoryFileCSV<Car> repo = RepositoryFileCSV<Car>(this->fileName);
    repo.loadFromFile();
    repo.setFileName(this->fileNameOut);
...
void TestsRepositoryFileCSVofCars::getCarByID()
{
    RepositoryFileCSV<Car> repo = RepositoryFileCSV<Car>(this->fileName);
    repo.loadFromFile();
    repo.setFileName(this->fileNameOut);
...
void TestsRepositoryFileCSVofCars::testGetAll()
{
    RepositoryFileCSV<Car> repo = RepositoryFileCSV<Car>(this->fileName);
    vector<Car> cars = repo.getAll();
    for (int i = 0; i < repo.getAll().size(); i++)
